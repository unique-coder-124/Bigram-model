...
block_size = int(sg.popup_get_text('block size \'powers of 2\' (atleast 2 times batch size): ')) # what is the maximum context length for predictions?
max_iters = int(sg.popup_get_text('max iterations \'multiple of 100\': '))
eval_interval = 1
learning_rate = 1e-3
...
max_response = int(input('response length(letters): '))
user_prompt = '\n\nuser: \n' + str(input("Please enter a starting prompt: "))
gpt_prompt = ''
...
while user_prompt != '\n\nuser: \n':
    ...
    # print('\n' + gpt_prompt + '\n')
    user_prompt = '\n\nuser: \n' + str(input("Please enter a prompt: "))
